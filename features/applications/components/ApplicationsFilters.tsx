  ...
  return (
    ...
    >
      ...
      <div className="flex items-end gap-2 sm:col-span-2 lg:col-span-1">
        <button
          type="submit"
          className="gold-gradient-bg focus-ring flex-1 rounded-full py-3 text-sm font-semibold text-[#090909]"
        >
          {labels.apply}
        </button>
        <Link
          href="/admin/applications"
          className="focus-ring rounded-full border border-white/10 px-4 py-3 text-sm text-white transition-colors hover:bg-white/[0.05]"
        >
          {labels.clear}
        </Link>
      </div>
