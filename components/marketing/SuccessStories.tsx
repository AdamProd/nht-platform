        ...
        >
          {creatorKeys.map((key) => (
            <motion.div
              key={key}
              variants={fadeUp}
              className="nht-card overflow-hidden"
            >
              <div className="border-b border-white/[0.05] px-8 pt-8 pb-6">
                <div className="flex items-center gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-[var(--nht-accent-muted)] text-base font-semibold text-[var(--nht-accent-warm)]">
                    {initials[key]}
                  </div>
                  <div>
              ...
              <div className="space-y-6 p-8">
                <div className="flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-1 text-sm font-semibold text-[var(--nht-accent-warm)]">
                    {t(`items.${key}.growth`)}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="rounded-xl border border-[var(--nht-border-hover)] bg-[var(--nht-accent-muted)] p-4">
                    <p className="text-overline text-[var(--nht-accent-warm)]">
                      {t("after")}
                    </p>
